...
controllers = "".join(open(gopath + '/src/github.com/davidrenne/goCoreCreateAppGeneration/controllers/constants.go', 'r').readlines())
...
path = '/src/github.com/davidrenne/goCoreCreateAppGeneration/web/app/globalization/translations/' + app + '/en/US.json'
...
if blastIt == "0" and key not in translations:
    ...
    if app == "app":
        translationGoCode = gopath + '/src/github.com/davidrenne/goCoreCreateAppGeneration/queries/appTranslations.go'
