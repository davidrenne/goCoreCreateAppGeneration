...
import (
	...
	"github.com/davidrenne/goCoreCreateAppGeneration/scheduleEngine"
	"github.com/davidrenne/goCoreCreateAppGeneration/settings"
	"github.com/davidrenne/goCoreCreateAppGeneration/viewModel/socketViews"
...
func WriteLog(uniqueId string, message string) (err error) {
	...
	log := "src/github.com/davidrenne/goCoreCreateAppGeneration/log/plugins/" + uniqueId + ".log"
	if uniqueId == "" {
		log = "src/github.com/davidrenne/goCoreCreateAppGeneration/log/app.log"
	}
