...
describe('Col', function () {
  ...
  it('Should add classes equals to props', function () {
    ...
    expect(className).toContain('flex-xs-12');
    expect(className).toContain('flex-sm-8');
    expect(className).toContain('flex-md-6');
    expect(className).toContain('flex-lg-4');
  });
  ...
  it('Should not replace class', function () {
    ...
    expect(className).toContain('flex-md-3');
  });
});