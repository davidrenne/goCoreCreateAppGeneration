...
describe('Row', function () {
    ...
    it('Should add modificators', function () {
        var row = TestUtils.renderIntoDocument(React.createElement(Row, { start: 'xs', center: 'sm', end: 'md', top: 'lg', middle: 'xs', bottom: 'sm', around: 'md', between: 'lg', first: 'xs', last: 'sm' }));
        var className = ReactDOM.findDOMNode(row).className;
